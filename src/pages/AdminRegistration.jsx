...
// Admin-specific validation schema (using only backend-supported fields)
const adminSchema = yup.object().shape({
  name: yup.string().required('Name is required'),
  dateOfBirth: yup
    .string()
    .required('Date of Birth is required')
    .test('age-range', 'Age must be between 25 and 65 years', function (value) {
...
const AdminRegistration = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      console.log('Submitting admin registration data:', data);
      ...
      const adminData = {
        ...
        role: 'ADMIN',
        userType: 'ADMIN',
        status: 'PENDING_APPROVAL', // Admin registrations need super admin approval
      ...
      alert('Admin registration submitted successfully! Please wait for Super Admin approval. You will receive an email with login credentials once approved.');
    ...
    <div className="login-page-container minimalist">
      <div className="auth-wrapper">
        <aside className="agri-highlights" aria-label="Agriculture highlights">
          <h2 className="agri-title">Admin Registration</h2>
          <ul className="agri-list">
            <li><span className="agri-emoji">👨‍💼</span><div><div className="agri-point">Official Access</div><div className="agri-sub">Manage system operations and users</div></div></li>
            <li><span className="agri-emoji">🛡️</span><div><div className="agri-point">Secure Process</div><div className="agri-sub">Email verification and approval required</div></div></li>
            <li><span className="agri-emoji">⚡</span><div><div className="agri-point">Quick Setup</div><div className="agri-sub">Get started in minutes</div></div></li>
          </ul>
        </aside>
        ...
        <div className="auth-card">
          <div className="auth-brand">
            ...
            <div className="auth-subtitle">Admin Registration Portal</div>
          </div>

          <div className="auth-field" style={{ marginTop: 6 }}>
            <h2 style={{ margin: 0 }}>Admin Registration Form</h2>
            <p style={{ color: '#6b7280', margin: '6px 0 0' }}>Enter your official details to register as an Admin</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="auth-form">
            <div className="form-grid-2">
              <div className="auth-field">
                ...
                <input type="text" {...register('name')} className={errors.name ? 'error' : ''} placeholder="Enter your full name" />
              ...
              <div className="auth-field">
                ...
                <input type="email" {...register('email')} value={emailValue} onChange={(e) => { setEmailValue(e.target.value); setOtpSent(false); setEmailVerified(false); }} className={errors.email ? 'error' : ''} placeholder="Enter your official email" />
              ...
              <div className="auth-field">
                ...
                <input type="password" {...register('confirmPassword')} className={errors.confirmPassword ? 'error' : ''} placeholder="Confirm your password" autoComplete="new-password" />
            ...
            <div className="auth-actions">
              <button type="submit" className="auth-submit">Register as Admin</button>
            </div>
